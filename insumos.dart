...
import 'package:projeto_v1/insumosInfo.dart';
...
class _InsumosState extends State<Insumos> {
  ...
  Stream<QuerySnapshot> obterCategorias() {
    return FirebaseFirestore.instance.collection('insumos').snapshots();
  }
            ...
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return widgetlisttile(categoria,
                      ExibirInsumosPorCategoria(categoria: categoria), context);
                },
              );
            },
          ),
